package com.ae.todolistapp.ui.adapter
...
import com.ae.todolistapp.databinding.TaskCardBinding
import com.ae.todolistapp.model.Task
import com.ae.todolistapp.ui.fragment.HomePageFragmentDirections
import com.ae.todolistapp.ui.viewmodel.HomePageViewModel
import com.ae.todolistapp.utils.changePage

class TaskAdapter(private var mContext: Context, var taskList: List<Task>, private var viewModel: HomePageViewModel) :
